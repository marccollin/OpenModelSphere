...
public class DbFindDialog extends JDialog implements ActionListener, TestableWindow {
    ...
    private void initComboBox() {
        ...
        // devrait pas
        // consommer l'�v�nement du VK_ENTER si son popup n'est pas visible. On
        // attend pour
        // r�gler ca ... Sun ont le temps de corriger ce pb d'ici la livraison
        // de l'outil
        // mrd. Si non corrig�, faudra v�rifier via combo.isPopupVisible() avant
        // de d�clancher
