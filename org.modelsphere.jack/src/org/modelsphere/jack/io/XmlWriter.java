 ...
 *  do not support neither diacritical characters (éà..) nor HTML special tags
...
public class XmlWriter extends Writer {
    ...
    private void init() {
        if (!init) {
            ...
            // diacritical characters, such as ���.. (from 192 (a grave) to 255
            // (y umlaut) )
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            htmlFileWriter.write("//symbols:  éàï\\n"); // NOT LOCALIZABLE, unit
            // test
