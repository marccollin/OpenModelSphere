...
public class HtmlWriter extends Writer {
    ...
    private void init() {
        if (!init) {
            ...
            setMapping('�', "&acirc;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&agrave;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&ccedil;"); // NOT LOCALIZABLE - HTML tag

            setMapping('�', "&ecirc;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&egrave;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&eacute;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&euml;"); // NOT LOCALIZABLE - HTML tag

            setMapping('�', "&icirc;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&iuml;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&ocirc;"); // NOT LOCALIZABLE - HTML tag

            setMapping('�', "&ucirc;"); // NOT LOCALIZABLE - HTML tag
            setMapping('�', "&ugrave;"); // NOT LOCALIZABLE - HTML tag
