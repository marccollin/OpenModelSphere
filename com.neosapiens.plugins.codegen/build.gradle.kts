...
val projectName = "com.neosapiens.plugins.codegen"
...
tasks {
    val dist by registering(Jar::class) {
        ...
        // Inclut les classes compilées + dépendances si nécessaire
        ...
        doLast {
            if (!targetPluginsDir.exists()) targetPluginsDir.mkdirs()
