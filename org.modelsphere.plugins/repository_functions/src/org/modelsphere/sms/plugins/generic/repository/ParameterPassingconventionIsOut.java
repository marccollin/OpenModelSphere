...
/**
 * For a parameter, tells whether its passing convention is OUT. <br>
 ...
 */
public final class ParameterPassingconventionIsOut extends UserDefinedField {
    private static final PluginSignature signature = new PluginSignature(
            "ParameterPassingconventionIsOut", "$Revision: 4 $",
            ApplicationContext.APPLICATION_AUTHOR, "$Date: 2009/04/14 14:00p $", 212); // NOT LOCALIZABLE

    public ParameterPassingconventionIsOut() {
    } //Parameter-less constructor required by jack.io.Plugins

    public ParameterPassingconventionIsOut(String ruleName, String subrule, Modifier[] modifiers)
...
} //end of ParameterPassingconventionIsOut
